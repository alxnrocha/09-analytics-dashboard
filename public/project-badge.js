(function () {
  const projectName = 'SunnyShop Analytics';
  const projectUrl = 'https://alxnrocha.github.io/analytics-dashboard/';
  const description = 'Painel de MÃ©tricas e AnalÃ­tica de E-Commerce';
