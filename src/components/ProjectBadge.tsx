  ...
  return (
    ...
    >
      ...
      <div style={{ marginBottom: '8px' }}>
        <a
          href="https://alxnrocha.github.io/analytics-dashboard/"
          target="_blank"
        ...
        >
          https://alxnrocha.github.io/analytics-dashboard/
        </a>
      </div>

      {/* Description */}
      <p style={{ color: '#8b949e', fontSize: '11px', lineHeight: 1.4, margin: '0 0 12px 0' }}>
        Painel de Métricas e Analítica de E-Commerce • Desenvolvido por{' '}
        <a
