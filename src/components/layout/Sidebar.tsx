      ...
      >
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div
              className="flex h-10 w-10 items-center justify-center rounded-2xl bg-amber-100 text-amber-500 shadow-xs"
              aria-hidden="true"
            >
          ...
          {onClose && (
            <button
              type="button"
              onClick={onClose}
              className="rounded-lg p-1.5 text-slate-400 hover:bg-slate-100 hover:text-slate-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 lg:hidden"
        ...
        {/* Navigation items */}
        <nav className="mt-8 flex flex-1 flex-col gap-1.5" aria-label="Menú principal">
          {navItems.map((item) => {
            ...
            return (
              <a
                ...
                className={`flex items-center gap-3.5 rounded-2xl px-4 py-3 text-sm transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 ${activeClasses}`}
              >
                <Icon
                  aria-hidden="true"
